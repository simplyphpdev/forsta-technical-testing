...
Create a new instance of UnitTests and call the method executeAllTests for a pass in all available tests, or call individual ones if needed.
Also single files are provided for ease of testing, they are provided on the single file folder.
